...
<body>
<div class="roundbaslik">OnPort - Öğrenme Nesneleri Portalı</div>
<div id="kutu1"><br>
Fakültesi BÖTE Bölümü Ögrencileri için ONPORT web sitesi yeniden tasarlanarak yayına başlamıştır.
</div><br><br>
...
<p class="dservisac" onclick="myFunction()"><a href="#">Moodle</a></p>
    ...
    <div id="dservis1">
     ...
     <a href="moodle.php" target="icerik">Devamı...</a></p>
    </div>
  ...
  <a href="onport.php" target="icerik">Devamı...</a></p>
      ...
      <p class="dservisac" onclick="myFunction3()"><a href="sbank.html">Soru Bankası</a></p>
